    ...
    <header style="position: relative; overflow: hidden;">
        ...
        <div class="video-background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; opacity: 0.3;">
            <div class="embed-responsive" style="padding-bottom: 42%; height: 100%;">
                <video class="embed-responsive-item" src="videos/Cinematography Reel.m4v" loading="eager" autoplay muted loop playsinline style="width: 100%; height: 100%; object-fit: cover;"></video>
            </div>
        </div>
